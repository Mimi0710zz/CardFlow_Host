...
function render(){renderDashboard();renderCustomers();renderCards();renderOrderTypes();renderCatalog();renderSystem();renderAbout();renderCashbackFeatures({state,getState:()=>state,save,uuid,toast});bindTables();bindHelpTabs();}
