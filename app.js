...
import {renderCashbackFeatures,renderCashbackDashboard} from "./services/cashback-feature-ui.js?v=20260901-statement-day-owner-v1";
...
function responsiveRowTitle(entity,row){
  ...
  if(entity==="detail-links")return [values[0],values[1],values[5]].filter(Boolean).join(" · ");
