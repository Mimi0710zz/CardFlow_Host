...
assert.equal(legacy.cardProducts[0].cardRank,"Classic/Standard");
assert.equal(legacy.cardProducts[0].ownershipType,"credit");
const debitLegacy=canonicalize({cardProducts:[{id:"d",cardId:"D",cardType:"debit"}]});
assert.equal(debitLegacy.cardProducts[0].ownershipType,"debit");
assert.equal(canonicalize({cardProducts:[{id:"s",cardRank:"Standard"}]}).cardProducts[0].cardRank,"Classic/Standard");
assert.equal(canonicalize({cardProducts:[{id:"i",cardRank:"Infinite"}]}).cardProducts[0].cardRank,"Infinite/Back Card");
assert.equal(canonicalize({cardProducts:[{id:"b",cardRank:"Black Card"}]}).cardProducts[0].cardRank,"Infinite/Back Card");
